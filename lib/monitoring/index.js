...
monserver.prototype.sendBackupStat = function (bserverOrig, output, callback) {
    var self = this;
    var backupHostState = 0;
    self.backupserverName = bserverOrig;
    var bserver = bserverOrig + '_backupsrv';
...
function createHost(self, bserver) {
    ...
    var bConfig = self.config.backupserver[self.backupserverName]
